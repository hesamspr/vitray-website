...
const customerLogos = [
  ...
  { name: 'Arvand',               id:  4, src: '/logos/Arvand.png' },
  { name: 'Aysan Pakhsh',         id:  5, src: '/logos/Aysan Pakhsh.png' },
  { name: 'Badr',                 id:  6, src: '/logos/Badr.png' },
  { name: 'Behin Pakhsh',         id:  7, src: '/logos/Behin Pakhsh.png' },
  { name: 'Behnoosh',             id:  8, src: '/logos/Behnoosh.png' },
  { name: 'Chador Maloo',         id:  9, src: '/logos/Chador Maloo.png' },
  { name: 'Chika',                id: 10, src: '/logos/Chika.png' },
  { name: 'Clever',               id: 11, src: '/logos/Clever.png' },
  { name: 'Coca Cola',            id: 12, src: '/logos/Coca Cola.png' },
  { name: 'Damavand',             id: 13, src: '/logos/Damavand.png' },
  { name: 'Dana Pakhsh',          id: 14, src: '/logos/Dana Pakhsh.png' },
  { name: 'Darik',                id: 15, src: '/logos/Darik.png' },
  { name: 'Delester',             id: 16, src: '/logos/Delester.png' },
  { name: 'Depoint',              id: 17, src: '/logos/Depoint.png' },
  { name: 'Doogh Abali',          id: 18, src: '/logos/Doogh Abali.png' },
  { name: 'Dorpad Tabriz',        id: 19, src: '/logos/Dorpad Tabriz.png' },
  { name: 'Fanavaran',            id: 20, src: '/logos/Fanavaran.png' },
  { name: 'Foolad Saeb',          id: 21, src: '/logos/Foolad Saeb.png' },
  { name: 'Gerad',                id: 22, src: '/logos/Gerad.png' },
  { name: 'GFT',                  id: 23, src: '/logos/GFT.png' },
  { name: 'Ghadir',               id: 24, src: '/logos/Ghadir.png' },
  { name: 'Haraz',                id: 25, src: '/logos/Haraz.png' },
  { name: 'Khoshgovar',           id: 26, src: '/logos/Khoshgovar.png' },
  { name: 'Laleh',                id: 27, src: '/logos/Laleh.png' },
  { name: 'Mahsham',              id: 28, src: '/logos/Mahsham.png' },
  { name: 'Maral',                id: 29, src: '/logos/Maral.png' },
  { name: 'Mashiz',               id: 30, src: '/logos/Mashiz.png' },
  { name: 'Mehr',                 id: 31, src: '/logos/Mehr.png' },
  { name: 'Midhco',               id: 32, src: '/logos/Midhco.png' },
  { name: 'Miva',                 id: 33, src: '/logos/Miva.png' },
  { name: 'Nahad Ketabkhane',     id: 34, src: '/logos/Nahad Ketabkhane.png' },
  { name: 'Noritaze',             id: 35, src: '/logos/Noritaze.png' },
  { name: 'Padide Kavosh',        id: 36, src: '/logos/Padide Kavosh.png' },
  { name: 'Pak',                  id: 37, src: '/logos/Pak.png' },
  { name: 'Pak Choob',            id: 38, src: '/logos/Pak Choob.png' },
  { name: 'Pak Dairy',            id: 39, src: '/logos/Pak Dairy.png' },
  { name: 'Paknaz',               id: 40, src: '/logos/Paknaz.png' },
  { name: 'Pakshooma',            id: 41, src: '/logos/Pakshooma.png' },
  { name: 'Parmidaa',             id: 42, src: '/logos/Parmidaa.png' },
  { name: 'Persi Gas',            id: 43, src: '/logos/Persi Gas.png' },
  { name: 'Resana',               id: 44, src: '/logos/Resana.png' },
  { name: 'Saam',                 id: 45, src: '/logos/Saam.png' },
  { name: 'Saba Energy',          id: 46, src: '/logos/Saba Energy.png' },
  { name: 'Salamat Pakhsh',       id: 47, src: '/logos/Salamat Pakhsh.png' },
  { name: 'Sara tel',             id: 48, src: '/logos/Sara tel.png' },
  { name: 'Simia cable',          id: 49, src: '/logos/Simia cable.png' },
  { name: 'Somaye',               id: 50, src: '/logos/Somaye.png' },
  { name: 'Taban Pakhsh Salamat', id: 51, src: '/logos/Taban Pakhsh Salamat.png' },
  { name: 'Tara',                 id: 52, src: '/logos/Tara.png' },
  { name: 'Telavang',             id: 53, src: '/logos/Telavang.png' },
  { name: 'Telavang Pakhsh',      id: 54, src: '/logos/Telavang Pakhsh.png' },
  { name: 'Tohfe Food',           id: 55, src: '/logos/Tohfe Food.png' },
  { name: 'Vitana',               id: 56, src: '/logos/Vitana.png' },
  { name: 'Yaghoot Sanat Tabriz', id: 57, src: '/logos/Yaghoot Sanat Tabriz.png' },
]
