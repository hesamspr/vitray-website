...
export const GlowingStarsBackgroundCard = ({
  ...
  return (
    <div
      ...
      className={cn(
        "bg-[linear-gradient(110deg,#111_0.6%,#0a0a0a)] p-4 h-full w-full rounded-2xl border border-border/60",
        className
      )}
    >
...
export const GlowingStarsTitle = ({
  ...
  return (
    <h3 className={cn("font-bold text-lg text-foreground mb-2", className)}>
      {children}
    </h3>
  );
};
